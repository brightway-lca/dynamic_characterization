...
Two optional extras are available: `fair` for the FAIR climate-model path, and `timex` for the [`bw_timex`](https://github.com/brightway-lca/bw_timex) case study in the demo notebooks:

```console
$ uv add "dynamic-characterization[fair]"
```
