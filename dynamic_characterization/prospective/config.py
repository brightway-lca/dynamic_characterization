...
The FAIR metrics ("fair_radiative_forcing", "fair_temperature") run against an SSP
marker rather than an IAM scenario, and are set with set_fair_scenario(ssp, rcp) -
see dynamic_characterization.prospective.available_fair_scenarios()."""
